...
router.post('/version_1/exemptions/check_exemptions', function(req, res) {
  res.redirect('/version_1/location/grid_reference_2');
});

// Where will the exemption activity take place?                                /version_1/location/grid_reference_2

router.post('/version_1/location/grid_reference_2', function(req, res) {
...
router.post('/version_1/contact/main_contact_postcode', function(req, res) {
  res.redirect('/version_1/contact/email_someone_else');
});

// Would you like a copy of the registration email sent to someone else?        /version_1/contact/email_someone_else

router.post('/version_1/contact/email_someone_else', function(req, res) {
